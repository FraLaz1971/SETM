...
# the crucial line of code is this 
# bbe -s -b $ccsds_packet_start:$dcurrent_packet_length $infile
# this gives on the stdout a block of bytes that start at byte n. $ccsds_packet_start with size $dcurrent_packet_length $infile
# examples of run:
# NECPreport/2018-12-12_tm.dds contains ELENA packets
#
#bin/dds2hexstrings.sh ~/Desktop/NECPreport/2018-12-12_tm.dds 20 2>/dev/null
#bin/dds2hexstrings.sh indata/dds/2019-07-22_2pkts_tm.dds
#bin/dds2hexstrings.sh indata/dds/2019-07-22_tm.dds 100  2>/dev/null | awk 'BEGIN{EPOCH=628509282}{print ($1-EPOCH),$2}' | graph -T ps -X "Time(s)" -Y "SSC" -L "Sequence Counter time series"  -h 0.7 -w 0.8 | okular -
