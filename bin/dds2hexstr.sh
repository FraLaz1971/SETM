#!/bin/bash
## this program dds2hexstr handles all packet in a given input dds binary format file
...
#  output: csv file containing a table with the following columns:
...
# example of run
# bin/dds2hexstr.sh  indata/dds/2019-07-22_tm.dds 5  2> log/2019-07-22_tm_err.log; cat log/2019-07-22_tm_err.log  | grep "###"
